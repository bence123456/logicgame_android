package com.bkonecsni.logicgame.gamecode.tents.types;
...
public class Type2Tile extends CommonTile {
    ...
    @Override
    public void init() {
        this.typeStatementList = Arrays.asList(new TypeStatement(Arrays.asList(new Condition(1, null)), Arrays.asList(new Update(1, Item.createWithSymbol("S1")))), new TypeStatement(Arrays.asList(new Condition(1, Item.createWithSymbol("S1"))), Arrays.asList(new Update(1, Item.createWithSymbol("S3")))), new TypeStatement(Arrays.asList(new Condition(1, Item.createWithSymbol("S3"))), Arrays.asList(new Update(1, null))));
    }
}
