package com.bkonecsni.logicgame.gamecode.binary_sudoku.types;
...
public class Type2Tile extends CommonTile {
    ...
    @Override
    public void init() {
        this.typeStatementList = Arrays.asList(new TypeStatement(Arrays.asList(new Condition(1, null)), Arrays.asList(new Update(1, Item.createWithIntValue(0)))), new TypeStatement(Arrays.asList(new Condition(1, Item.createWithIntValue(0))), Arrays.asList(new Update(1, Item.createWithIntValue(1)))), new TypeStatement(Arrays.asList(new Condition(1, Item.createWithIntValue(1))), Arrays.asList(new Update(1, null))));
    }
}
